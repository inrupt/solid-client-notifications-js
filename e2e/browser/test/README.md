...
One thing to note is that its dependency on solid-client-notifications is on the code _inside
...
actually call out to solid-client-notifications, i.e. that are run in the actual test. The
